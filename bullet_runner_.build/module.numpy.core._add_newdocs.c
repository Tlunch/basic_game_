...
static PyObject *impl_numpy$core$_add_newdocs$$$function__1_refer_to_array_attribute(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_d25b6ccc2bafcf2b5db79967d6b4731c = MAKE_FUNCTION_FRAME(codeobj_d25b6ccc2bafcf2b5db79967d6b4731c, module_numpy$core$_add_newdocs, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_d25b6ccc2bafcf2b5db79967d6b4731c);
