    ...
    }
    {
        ...
        tmp_args_element_value_3 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            if (unlikely(tmp_kw_call_dict_value_0_1 == NULL)) {
                tmp_kw_call_dict_value_0_1 = GET_MODULE_VARIABLE_VALUE_FALLBACK(mod_consts[102]);
            }
            ...
            frame_0357497fae0c9255e15cb454ed4c2377->m_frame.f_lineno = 246;
            {
                ...
                tmp_tuple_element_1 = CALL_FUNCTION_WITH_ARGS1_KWSPLIT(unicode_builtin_format, args, kw_values, mod_consts[105]);
            }
